...
export default function SubTrackDetails() {
  ...
  return (
    <>
      ...
      <SEO
        title={`${subCategory.subCategoryName} Roadmap – ${categoryName} | TeckTrack`}
        description={`Free ${subCategory.subCategoryName} learning path with ${filteredTracks.length} tracks.`}
        url={`https://tecktrack.vercel.app/roadmap/${categoryId}/${subCategoryId}`}
      />
