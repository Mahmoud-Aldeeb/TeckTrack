...
const RoadmapPage = () => {
  ...
  return (
    <>
      <SEO
        title="Developer Roadmap 2025 - Step by Step Guides | TechTrack"
        description="Free structured developer roadmaps for 2025. Master Web Development, Mobile, Data Science, DevOps, Cybersecurity & more with real company interview skills."
        url="https://teck-track.vercel.app/roadmap"
      />

      <div className="min-h-screen bg-white pt-16 sm:pt-20 flex flex-col items-center">
        <section className="w-full max-w-4xl px-4 sm:px-6 lg:px-8 my-10 sm:my-12 lg:my-16 text-center">
          ...
          <div className="w-32 md:w-48 h-px bg-gray-900 mx-auto mt-12" />
        </section>

        <section className="w-full px-4 sm:px-6 lg:px-8 pb-16 sm:pb-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 xl:w-10/12 mx-auto gap-6 sm:gap-8 lg:gap-10 xl:gap-12 place-items-center">
            {tracks.map((track) => (
              <div
