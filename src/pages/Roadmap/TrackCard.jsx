...
const TrackCard = ({ title, desc, img, categoryId }) => {
  return (
    <div
      className="relative overflow-hidden rounded-2xl group w-full h-[280px] xs:h-[320px] sm:h-[380px] md:h-[420px] lg:h-[460px] lg:w-[400px] md:w-[300px] xl:h-[500px] xl:w-[400px] transition-all duration-300 hover:shadow-2xl mx-auto"
    >
